...
사례 : 전세 세입자인 A씨는 어느는아 날 임대인에게서 전화 한 통을 받았어요. 대출을 받아야 한다고, 잠시 집에서 전출해줄 수 있냐는 임대인의 요청이 있었어요. A씨는 별문제가 없을 거라 판단해 임대인이 대출받는 날 잠깐 전출하고 다시 전입신고를 했죠. 그런데 이후 A씨가 전세자금 대출을 연장하려고 하자 은행에선 A씨의 대출 연장을 거절했어요.
